...
Opción 2: Ejecución manual con MySQL
Abrir MySQL Workbench (o cualquier cliente MySQL)
Crear la base de datos:
CREATE DATABASE proyecto;
USE proyecto;
Ejecutar los scripts en el siguiente orden:
db/schema.sql → crea las tablas
db/seed.sql → inserta los datos
(Opcional) Ejecutar consultas de prueba:
db/queries.sql
